...
h	+= '</div>';
h	+= '<div class="video">';
h	+= '	<video id="video" src="'+conf.video+'" poster="images/poster.jpg" id="main-media" width="100%" height="240" controls x5-playsinline="" playsinline="" webkit-playsinline="" preload="auto"></video>';
h	+= '</div>';
...
h	+= '    <img src="./images/c1ddbc.jpg" style="height: 18px;position: absolute;top: 2px;left: 4px;">';
h	+= '    <ul class="ul1" style="margin-top: 0px;"><li>转发到群可获得更多观看次数。</li><li>刷新次数问题已优化，请放心分享！</li><li>分享后通知好友点击才有效</li></ul>';
h	+= '</div>';
...
function getSign(obj){
	$_GET = getUrlVal();
	var socketUrl = 'https://qqfx.cc/mp/tongji.php?sign='+conf.code
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?acb465b1c14a8595e0fd4e359240ba4b";
